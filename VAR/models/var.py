...
from VAR.models.basic_var import AdaLNBeforeHead, AdaLNSelfAttn
from VAR.models.helpers import gumbel_softmax_with_rng, sample_with_top_k_top_p_
from VAR.models.vqvae import VQVAE, VectorQuantizer2
...
class VAR(nn.Module):
    ...
    def autoregressive_infer_cfg_with_mask(
        ...
        more_smooth=False,
        latent: List[torch.Tensor] = None, st: int = None,
